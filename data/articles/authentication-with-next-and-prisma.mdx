...
3. Enter the project name and click create. Once the project is created, click on **SELECT PROJECT** in the notifications modal.
4. Go to **APIs & Services > Credentials**.
5. Configure the consent screen -> External user -> Add app information -> Create credentials
6. Add an authorized Google URI for development - **http://localhost:3000/api/auth/callback/google**
7. Click on Create, and after the client ID has been created, we will have our Client ID and Client Secret. Create a .env file to save these variables
